...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "keByUTLS#mpAfQZOLNlFOtuUVep4Vj0SdeV6hEPav4CDARN4sqE4", //your session id
MV_SEND_JID: process.env.MV_SEND_JID || "94729787750@g.whatsapp.net", //default movie send group
